...
const HyperfocusCard = dynamic(() => import("@/app/components/HyperfocusCard").then(mod => mod.HyperfocusCard), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const HyperfocusList = dynamic(() => import("@/app/components/HyperfocusList").then(mod => mod.HyperfocusList), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const TaskBreakdown = dynamic(() => import("@/app/components/TaskBreakdown").then(mod => mod.TaskBreakdown), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const SubtaskSuggestions = dynamic(() => import("@/app/components/SubtaskSuggestions").then(mod => mod.SubtaskSuggestions), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const FocusTimer = dynamic(() => import("@/app/components/FocusTimer").then(mod => mod.FocusTimer), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const FocusSessionSummary = dynamic(() => import("@/app/components/FocusSessionSummary").then(mod => mod.FocusSessionSummary), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const ContextAnalysis = dynamic(() => import("@/app/components/ContextAnalysis").then(mod => mod.ContextAnalysis), {
  loading: () => <ComponentLoading />,
  ssr: false
})

const AlternancyFlow = dynamic(() => import("@/app/components/AlternancyFlow").then(mod => mod.AlternancyFlow), {
  loading: () => <ComponentLoading />,
  ssr: false
})
